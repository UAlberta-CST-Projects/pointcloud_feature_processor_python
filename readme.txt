...
cloudcompare must be installed and be callable from the command line.

Usages:
1. You can simply run the cc_standalone.py file and it will guide you through the process.
